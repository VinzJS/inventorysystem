...
class releasing{
	...
	public function list_releasing(){
			 $sql="SELECT * FROM releasing_stock";
	...
	function get_rls_id($stock_code) {
		$sql = "SELECT rls_id FROM receiving_stock WHERE stock_code = :code";
